...
const getStyles = (setSelected) => {
  return StyleSheet.create({
    wrapper: {
      ...
      paddingBottom: setSelected == "" ? 12 : 0,
      paddingTop: setSelected == "" ? 12 : 0,
      flexDirection: "row",
    ...
    dropdown: {
      ...
      borderRadius: 10,
      borderColor: "gray",
      marginTop: 10, // Use a prop como valor padrão ou 0 se não for fornecido
      overflow: "hidden",
    },
    option: {
